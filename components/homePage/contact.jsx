...
const Contact = ({ tableBgColor, sectionBgColor }) => {
  return (
    <div className={`bg-${sectionBgColor} px-[16px] py-[80px] md:gap-x-[35px] md:px-[120px] lg:flex lg:items-center lg:justify-center lg:gap-x-[70px]`}>
      ...
      <div className="mt-6 md:mt-0">
        <form className={`rounded-lg border border-white bg-${tableBgColor} p-10`}>
          ...
          <textarea placeholder="What can we help you with?" className="mt-[20px] w-full resize-none rounded-[10px] border border-color-1 p-4" />

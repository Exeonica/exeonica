...
const RevenueSection = () => {
  return (
    <div className="my-[80px] px-[16px] md:mx-[60px] lg:my-[70px]">
      <div className="flex flex-col rounded-3xl bg-primary md:flex-row">
        <div className="flex justify-center px-[11.5px] md:pt-[70px] lg:ml-[81.85px] lg:mt-0 lg:w-2/5 lg:justify-start">
        ...
        <div className="mt-6 px-[21.5px] pt-[10px] text-[20px] font-semibold leading-7 sm:pt-[0px] md:w-3/5 md:gap-[24px] md:py-[60px] md:pl-[60px] md:pr-[81.85px] md:pt-[70px] md:text-left">

...
const RevenueSection = () => {
  return (
    <div className="my-[80px] md:mx-[60px] lg:mx-[110px]">
      <div className="flex flex-col rounded-3xl bg-primary md:flex-row md:py-[0px]">
        ...
        <div className="mt-6 px-[21.5px] pt-[60px] text-[20px] font-semibold leading-7 md:w-3/5 md:gap-[24px] md:pl-[60px] md:pr-[81.85px] md:pt-[70px] md:text-left">

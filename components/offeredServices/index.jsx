      ...
      <div className="mt-[70px] lg:flex lg:items-center lg:justify-between lg:gap-x-[100px]">
        <div className="lg:w-[50%]">
          {service.offers.map((item, index) => (
            <div key={index}>
              <p className="px-[30px] py-[30px] text-2xl font-semibold text-color-1 hover:rounded-[15px] hover:border hover:border-primary hover:bg-primary hover:text-color-12">{item.title}</p>
            </div>
          ))}
        </div>

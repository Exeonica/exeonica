          ...
          <div key={card.id} className="flex rounded-[16px] p-[24px] shadow-lg">
            <div className="cursor-pointer overflow-hidden rounded bg-white">
              ...
              <div className="pt-[24px]">
                ...
                <div className="flex">
                  <h2 className="mb-[12px] text-[26px] font-semibold leading-[32px] text-color-10">{card.title}</h2>
              ...
              <div className="mb-[32px] flex">
                ...
                <div>
                  <p className="text-[15px] font-semibold leading-[20px] text-color-10">{card.profileName}</p>

...
const ServiceDetailsHeader = ({ service }) => {
  return (
    <div className="bg-gradient-to-b from-white to-color-11 px-[16px] py-[60px] lg:flex lg:items-center lg:justify-between lg:space-x-[60px] lg:px-[120px] lg:py-[50px] xl:space-x-[179px]">
      <div>

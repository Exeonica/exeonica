export const strings = {
  ...
  aboutDescription:
    "At exeonica, we're dedicated to harnessing the power of AI and custom software development to drive business transformation. With over seven years of experience, we specialize in delivering innovative and tailored solutions that leverage the latest technologies to streamline operations, boost efficiency, and foster growth.",
  ...
  copyRight: "Copyright ©️ 2024 exeonica. All rights reserved.",
  whyChooseUs: "Why exeonica Solutions?",
  ...
  email: "Email Us",
  companyMail: "hello@exeonica.com",
  contact: "Contact Us",
  companyContact: "+44 7349 318187",
  nameInput: "Full Name",
  emailInput: "Email Address",
  messageInput: "Message",
  checkInput: "I’d like to occasionally receive other communication from exeonica, such as contact and product news",
  contactBtn: "Submit",
